...
list.insert(0, "Canada") # Add Canada to the beginning of the list
print("(2)", list)
...
list.insert(2, "Germany") # Add Germany to the list at index 2
print("(5)", list)

list.insert(5, "Norway") # Add Norway to the list at index 5
print("(6)", list)
